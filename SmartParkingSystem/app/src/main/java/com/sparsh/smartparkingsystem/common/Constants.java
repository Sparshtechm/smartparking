...
public class Constants {
    ...
    public static final String kF_name           = "f_name";
    public static final String kL_name           = "l_name";
    public static final String kcode             = "code";
    static final String kcust_name               = "customer_name";
    public static final String kcust_id          = "customer_id";
    public static final String kemail            = "email";
    public static final String kContact_no       = "contact_no";
